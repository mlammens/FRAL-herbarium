...
* Speckled Alder = Alnus rugosa (ALINR)
* Grey Alder = Alnus incana (ALIN2) 
* Smooth Alder = Alnus serrulata (ALSE2)
* Alder (Alderleaf) Buckthorn = Rhamnus alnifolia (RHAL)
* White Ash = Fraxinus americana (FRAM2)
* Witch Hazel = Hamamelis virginiana (HAVI4) 
* Witch Hazel (syn) = Hamamelis macrophylla (HAVI4)
...
#HERB_PROJECT_DIR <- '/Users/maiellolammens/Dropbox/F-Alnus/Herbarium-Project/Chapter-3-FRAL-Retrospective/'
HERB_PROJECT_DIR <- '/Users/maiellolammens/Dropbox/Projects/FRAL-herbarium/'
...
## Load falnus.extent
load(paste(HERB_PROJECT_DIR,'scripts/falnus.extent.RData', sep = ''))
